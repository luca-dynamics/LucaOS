...
export interface ToneDimensions {
  ...
  emotionalOpenness: number; // 0 (reserved) to 100 (enthusiastic)
  formality: number; // 0 (professional) to 100 (casual)
  directness: number; // 0 (diplomatic) to 100 (blunt)
  humor: number; // 0 (subtle wit) to 100 (overt sarcasm)
}
...
export const TONE_STYLES: Record<ToneStyleId, ToneStyleConfig> = {
  BRIEF: {
    id: "BRIEF",
    name: "Brief",
    description: "Concise, casual, and direct with minimal fluff.",
    dimensions: {
      expressiveness: 10,
  ...
  CHILL: {
    id: "CHILL",
    name: "Chill",
    description: "Relaxed, casual, and slightly detached but friendly.",
    dimensions: {
      expressiveness: 40,
      emotionalOpenness: 40,
      formality: 10,
      directness: 50,
      humor: 40,
    },
  ...
  SWEET: {
    id: "SWEET",
    name: "Sweet",
    description: "Warm, enthusiastic, and encouraging.",
    dimensions: {
      expressiveness: 60,
  ...
  CUSTOM: {
    id: "CUSTOM",
    name: "Custom",
    description: "Your own personalized mix across the five dimensions.",
    dimensions: {
      expressiveness: 50,
...
export interface LucaPersonality {
  ...
  coreIdentity: {
    name: "Luca";
    nature: "Large Universal Control Agent";
