...
export const generateThemeStyles = () => {
  return `
    :root {
      --rq-blue: ${THEME_PALETTE.RUTHLESS.primary};
      --rq-blue-dim: ${THEME_PALETTE.RUTHLESS.dim};
      --rq-green: ${THEME_PALETTE.HACKER.primary};
      --rq-green-dim: ${THEME_PALETTE.HACKER.dim};
      --rq-amber: ${THEME_PALETTE.ENGINEER.primary};
      --rq-amber-dim: ${THEME_PALETTE.ENGINEER.dim};
...
export const PERSONA_UI_CONFIG: Record<string, any> = {
  ...
  RUTHLESS: {
    ...
    bg: "bg-rq-blue-dim",
    glow: `shadow-[0_0_20px_${THEME_PALETTE.RUTHLESS.primary}]`,
  ...
  HACKER: {
    ...
    bg: "bg-[#121212]",
    glow: `shadow-[0_0_20px_${THEME_PALETTE.HACKER.primary}]`,
 ...
 */
export const getThemeColors = (persona: string = "ASSISTANT") => {
  return PERSONA_UI_CONFIG[persona] || PERSONA_UI_CONFIG.ASSISTANT;
};
