  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/40 glass-blur animate-in fade-in duration-300">
      ...
      >
        ...
        <div
          className="absolute inset-0 opacity-20 pointer-events-none transition-all duration-700 z-0"
          style={{
        ...
        <div
          className="h-12 border-b border-slate-800 flex items-center justify-between px-4 relative z-10"
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              className={`text-[10px] font-mono font-bold px-2 py-0.5 md:rounded-lg ${
                isRealData ? `${themePrimary}` : "bg-slate-800 text-slate-500"
              }`}
              style={isRealData ? { backgroundColor: `${themeHex}33` } : {}}
            >
            ...
            <div className="relative text-center max-w-2xl animate-in fade-in zoom-in-95 duration-500">
              ...
              <button
                ...
                className={`group relative px-6 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-bold text-base md:text-lg text-white
                          bg-gradient-to-r border-2 ${themeBorder}
        ...
        {account && (
          <div className="flex-1 flex">
            {/* Left: Quotes Panel */}
            <div
              className="w-64 border-r border-slate-800 flex flex-col transition-colors duration-500"
              style={{ backgroundColor: `${themeHex}0D` }}
            >
              <div
                className="p-3 text-[10px] font-bold text-slate-500 tracking-wider"
      ...
      `}
              ...
              <div className="h-64 flex flex-col bg-transparent">
                {/* Account Stats Bar */}
                <div
                  className="h-10 border-b border-slate-800 flex items-center px-4 gap-8 text-xs font-mono text-slate-400"
                  style={{ backgroundColor: `${themeHex}1A` }}
                >
                  <div>
                    BALANCE:{" "}
                ...
                {/* Table Header */}
                <div
                  className="grid grid-cols-7 px-4 py-2 text-[10px] font-bold text-slate-500 border-b border-slate-800"
