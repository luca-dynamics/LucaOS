  ...
  return (
    <div className="fixed inset-0 z-[190] flex items-center justify-center bg-black/80 glass-blur animate-in fade-in duration-200 font-mono">
      ...
      >
        ...
        {/* Header */}
        <div
          className={`h-16 border-b ${themeBorder}/50 flex items-center justify-between px-6 select-none`}
        ...
        <div className="flex-1 flex flex-col sm:flex-row overflow-hidden">
          {/* Sidebar */}
          <div
            className="w-full sm:w-64 border-b sm:border-b-0 sm:border-r border-slate-800 flex flex-col h-56 sm:h-auto shrink-0 overflow-hidden"
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-1">
              ...
              {files.map((file, i) => (
                <button
                  key={i}
                  className={`w-full text-left px-2 py-1 rounded text-xs flex items-center gap-2 hover:bg-white/5 group ${
