...
const SubsystemDashboard: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-300 font-mono p-0 sm:p-4">
      <div
        className={`relative w-full h-full sm:h-[90vh] sm:w-[95%] max-w-7xl bg-black/40 backdrop-blur-xl border-none sm:border ${themeBorder}/30 rounded-none sm:rounded-lg flex flex-col overflow-hidden`}
        style={{
