  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in zoom-in-95 duration-300 overflow-y-auto sm:overflow-hidden">
      ...
      >
        ...
        {/* Header */}
        <div
          className={`h-16 border-b ${themeBorder}/50 flex items-center justify-between px-6 relative z-10`}
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden">
          {/* Left: Market List */}
          <div
            className={`w-full lg:w-80 border-b lg:border-b-0 lg:border-r ${themeBorder}/30 flex flex-col max-h-48 lg:max-h-none overflow-hidden transition-colors duration-500`}
          ...
          >
            <div className={`p-4 border-b ${themeBorder}/30 flex gap-2`}>
              ...
              <button
                ...
                className={`p-2 ${themePrimary} rounded transition-colors`}
                style={{ backgroundColor: `${themeHex}1F` }}
                onMouseEnter={(e) => {
              ...
              {markets.map((market, i) => (
                <div
                  ...
                  className={`p-4 border-b border-slate-800 cursor-pointer hover:bg-slate-900/50 transition-colors ${
                    selectedMarket?.id === market.id ? `border-l-2` : ""
                  }`}
                  style={
          ...
          <div className="flex-1 flex flex-col relative p-4 sm:p-8 min-h-[400px] lg:min-h-0 bg-transparent">
            {selectedMarket ? (
          ...
          {/* Right: Portfolio */}
          <div
            className={`w-full lg:w-64 border-t lg:border-t-0 lg:border-l ${themeBorder}/30 flex flex-col max-h-48 lg:max-h-none transition-colors duration-500`}
            style={{ backgroundColor: `${themeHex}0D` }}
          >
            <div
