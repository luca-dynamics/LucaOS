...
import { Activity, X, Trophy, Wrench } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in zoom-in-95 duration-300 font-mono p-0 sm:p-4 overflow-hidden">
      ...
      >
        ...
        <div
          className={`flex items-center justify-start sm:justify-center border-b ${currentThemeBorder}/10 p-1 overflow-x-auto no-scrollbar`}
          style={{ backgroundColor: `${currentThemeHex}0A` }}
        >
          <div className="flex items-center gap-1">
            <button
              onClick={() => setActiveTab("dashboard")}
              className={`px-3 sm:px-4 py-1.5 rounded text-[10px] sm:text-xs font-bold tracking-wider transition-all whitespace-nowrap border border-transparent ${
                activeTab === "dashboard"
