    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 z-10">
        ...
        <button
          ...
          className="p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 active:scale-95 flex flex-col items-center gap-2 transition-all shadow-[0_0_15px_rgba(168,85,247,0.1)]"
          style={{
            borderColor: `${theme.hex}40`,
          }}
        >
