...
describe("skill sandbox readiness", () => {
  it("summarizes review, approval, and blocked plans without execution readiness", () => {
    ...
    expect(result).toMatchObject({ totalPlans: 7, readyForReview: 3, approvalRequired: 2, blocked: 2, readyForExecution: false, executionEnabled: false, sideEffectsPerformed: false });
