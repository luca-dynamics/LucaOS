...
import type { PersonalIntelligenceRuntimeAuthorityPolicyInput, PersonalIntelligenceRuntimeAuthorityRecord } from "./runtimeAuthorityTypes";
...
const definitions: readonly (PersonalIntelligenceRuntimeAuthorityPolicyInput & { id: string })[] = [
  ...
  { id: "pilot-candidate", source: "fixture", capabilityKind: "skill_execution", riskLevel: "low", dryRunSuccessful: true, requiredGatesGrantedForReview: true, hasBlockedDeniedOrExpiredGates: false, missionAlignment: "aligned", rollbackExpectationExists: true, runtimeTracePreviewExists: true, permanentBlockedCapabilityPresent: false },
  { id: "malformed", source: "fixture", capabilityKind: "malformed_capability", riskLevel: "medium" },
];

function createFixture({ id, ...input }: PersonalIntelligenceRuntimeAuthorityPolicyInput & { id: string }): PersonalIntelligenceRuntimeAuthorityRecord {
  const capabilityKind: PersonalIntelligenceRuntimeAuthorityRecord["capabilityKind"] = input.capabilityKind === "malformed_capability"
    ? "unknown"
...
export const personalIntelligenceRuntimeAuthorityFixtures: readonly PersonalIntelligenceRuntimeAuthorityRecord[] = Object.freeze(definitions.map(createFixture));
