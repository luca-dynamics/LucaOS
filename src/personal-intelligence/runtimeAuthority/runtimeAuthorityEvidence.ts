import type { PersonalIntelligenceRuntimeAuthorityEvidence, PersonalIntelligenceRuntimeAuthorityRecord } from "./runtimeAuthorityTypes";
...
export function createPersonalIntelligenceRuntimeAuthorityEvidence(record: PersonalIntelligenceRuntimeAuthorityRecord, context: RuntimeAuthorityEvidenceContext = {}): PersonalIntelligenceRuntimeAuthorityEvidence {
  return {
