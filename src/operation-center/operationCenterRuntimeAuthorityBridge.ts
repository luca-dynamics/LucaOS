...
const mandatoryBlockedActions = ["skill execution", "tool invocation", "model call", "memory write", "LucaLink handoff", "runtime authority grant"];

export function createOperationItemsFromRuntimeAuthorityRecords(records: readonly PersonalIntelligenceRuntimeAuthorityRecord[]): OperationCenterItem[] {
