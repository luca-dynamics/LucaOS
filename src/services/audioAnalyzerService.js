    ...
    async analyzeAudio(audioFilePath, options = {}) {
        ...
        try {
            ...
            const instructionSection = customInstruction 
                ? `\n5. **USER INSTRUCTION**: "${customInstruction}" - Pay special attention to this.` 
                : '';
...
4. Important notifications (alarms, alerts, beeps)${instructionSection}

For each detected event, provide:
- Event type (e.g., "doorbell", "smoke_alarm", "phone_ring", "unusual_noise", "user_alert")
...
Return your response in JSON format:
{
  ...
  "summary": "Brief summary of audio content"
            ...
            // Respect user settings if available
