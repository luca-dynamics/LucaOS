...
export const lucaBootExperiencePhases: LucaBootExperiencePhase[] = [
  {
    ...
    followUpNotes: [
      "Split standard-user copy from BIOS diagnostic copy before polishing the visible boot surface.",
  ...
  },
  {
    ...
    audience: ["standard", "tactical", "origin"],
    userFacingCopy: ["LOADING LUCA OS"],
    internalSignals: [
...
export const lucaBootExperienceCopy: LucaBootExperienceCopyItem[] = [
  {
    ...
    note: "Distinctive but tactical; likely too technical as the only standard-user frame.",
  },
  {
    surface: "bios-terminal",
    text: "CORTEX CORE (RAG)",
    assessment: "needs-product-language-review",
    note: "Accurate diagnostic copy for tactical/origin users, but standard users need a softer local-brain label.",
  },
  {
    surface: "kernel-loader",
    text: "LOADING LUCA OS",
    assessment: "polished",
    note: "Short and brand-aligned, though it does not explain readiness work.",
  },
  {
    surface: "onboarding-flow",
    text: "KERNEL AWAKENING IN PROGRESS...",
    assessment: "diagnostic",
    note: "Cinematic and identity-rich, but should be reviewed against the separate app boot terminal language.",
  },
  {
    surface: "mode-select",
