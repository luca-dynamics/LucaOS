...
import type { Session, LucaLinkMessage } from "./types";

/**
 * SessionManager - Manages Luca Link sessions with persistence
 *
 * Features:
...
export class SessionManager {
  ...
  private masterPassword: string = "luca-link-master-key"; // In production, use secure key storage
   ...
   */
  async getQueuedMessages(deviceId: string): Promise<LucaLinkMessage[]> {
  ...
  async processQueue(
    deviceId: string,
    sendFn: (message: LucaLinkMessage) => Promise<void>
