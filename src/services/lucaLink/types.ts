...
export interface LucaLinkError {
  code: string;
...
export interface LucaLinkConfig {
  encryption: {
...
export interface LucaLinkEvent {
  type: LucaLinkEventType;
  data?: any;
  timestamp: number;
}
