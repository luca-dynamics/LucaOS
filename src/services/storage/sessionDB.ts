...
import type { Session, LucaLinkMessage } from "../lucaLink/types";

/**
 * IndexedDB Schema for Luca Link
 */
interface LucaLinkDB extends DBSchema {
  sessions: {
...
/**
 * SessionDB - IndexedDB wrapper for Luca Link session storage
 *
 * Features:
...
export class SessionDB {
  private db: IDBPDatabase<LucaLinkDB> | null = null;
  private readonly DB_NAME = "luca-link-db";
  ...
  async init(): Promise<void> {
    ...
    this.db = await openDB<LucaLinkDB>(this.DB_NAME, this.DB_VERSION, {
      upgrade(db) {
        // Sessions store
