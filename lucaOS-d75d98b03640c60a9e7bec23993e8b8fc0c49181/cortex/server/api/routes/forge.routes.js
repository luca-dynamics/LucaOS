...
import { FORGE_DIR, SKILLS_DIR } from '../../config/constants.js';

const router = express.Router();

// Forge recipes directory
const RECIPES_DIR = path.join(FORGE_DIR, 'recipes');
const APPS_DIR = path.join(FORGE_DIR, 'apps');

// Ensure base directories exist
[FORGE_DIR, RECIPES_DIR, APPS_DIR, SKILLS_DIR].forEach(dir => {
    if (!fs.existsSync(dir)) {
        fs.mkdirSync(dir, { recursive: true });
        console.log(`[FORGE] Initialized directory: ${dir}`);
    }
});
