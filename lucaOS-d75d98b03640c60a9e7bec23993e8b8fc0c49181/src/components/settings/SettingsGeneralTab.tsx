            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 mr-2">
                ...
                <input
                  ...
                  className="w-3 h-3 rounded appearance-none border border-white/10 bg-black/40 cursor-pointer"
                  style={{ accentColor: theme.hex }}
                />
              </div>
              <div className="text-[8px] font-mono text-gray-500 uppercase tracking-widest border-l border-white/5 pl-3">
                ...
                {(
                  ...
                  return (
                    <button
                      ...
                      style={{ borderColor: isActive ? theme.hex : undefined }}
                    >
                      {p}
                    </button>
                  );
                  ...
                  return (
                    <button
                      ...
                      className={`py-1.5 rounded border text-[8px] font-mono transition-all flex items-center justify-center gap-1.5 ${
                        isActive ? "bg-white/10" : "bg-black/20 border-white/5"
                      } ${settings.general.syncThemeWithPersona ? "opacity-20 cursor-not-allowed" : "opacity-60"}`}
                      style={{
                        borderColor: isActive ? cfg.hex : "transparent",
                      }}
                    >
                      <div
              ...
              <div className="space-y-1.5 p-2 rounded bg-white/5 border border-white/5">
                ...
                {profileStatus.lastSync && (
                  <div className="text-[8px] text-gray-500 font-mono ml-3.5">
                    SYNCED: {new Date(profileStatus.lastSync).toLocaleString()}
                  </div>
                )}
              </div>
            )}
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <Icon
                      ...
                      style={{
                        color: isEnabled ? theme.hex : "#6b7280",
                      }}
                    />
                    <div>
                      <span
