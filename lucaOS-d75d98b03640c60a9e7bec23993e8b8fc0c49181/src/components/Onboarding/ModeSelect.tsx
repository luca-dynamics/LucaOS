    ...
    <div className="space-y-4 sm:space-y-8 animate-fade-in-up w-full max-w-2xl px-4 sm:px-0">
      ...
      <div className="text-center space-y-2 sm:space-y-3">
        ...
        <div className="hidden sm:flex justify-center mb-4">
          ...
          `}
          >
            <MessageCircle className={`w-8 h-8 ${iconColor}`} />
          </div>
        </div>

        <h1
          className={`text-xl sm:text-2xl font-bold tracking-widest uppercase ${textHeading}`}
        >
          How would you like to talk?
        </h1>
        <p className={`${textMuted} text-xs sm:text-sm`}>
