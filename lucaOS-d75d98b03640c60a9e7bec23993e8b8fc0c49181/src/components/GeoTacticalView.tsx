    ...
    const render = () => {
      ...
      for (let lat = -80; lat <= 80; lat += 20) {
        ...
        ctx.strokeStyle = theme
          ...
          : "rgba(6, 182, 212, 0.1)"; // Very dim Cyan
        ctx.stroke();
      }
      ...
      gradient.addColorStop(
        0,
        theme ? setHexAlpha(theme.hex, 0) : "rgba(6, 182, 212, 0)",
      );
      gradient.addColorStop(
        1,
        theme ? setHexAlpha(theme.hex, 0.1) : "rgba(6, 182, 212, 0.1)",
      );
      ...
      >
        ...
        <div
          ...
          style={
            theme
              ? {
                  backgroundImage: `linear-gradient(${setHexAlpha(
                    theme.hex,
                    0.2,
                  )} 1px,transparent 1px),linear-gradient(90deg,${setHexAlpha(
                    theme.hex,
                    0.2,
                  )} 1px,transparent 1px)`,
                }
