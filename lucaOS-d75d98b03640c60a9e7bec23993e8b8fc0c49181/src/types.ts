...
export interface Goal {
  ...
  lastRun: number | null;
  logs: any[];
  workflowId?: string; // Link to LucaWorkforce workflow
  subtasks?: any[]; // Snapshot of specialized persona tasks
}
...
export interface PersonaDefinition {
  ...
  instruction: string;
  // Architecture Split
  baseInstruction?: string; // The "Golden" system prompt (Archetype)
  userInstruction?: string; // User's custom behavioral tuning
  isProtected?: boolean; // If true, baseInstruction is locked by default
}
...
export interface PersonaConfig {
  ...
  globalInstructions?: string; // The "One Mind" tuning
}
