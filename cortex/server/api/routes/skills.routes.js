...
// Luca Imprinting: Save recording as a new skill folder
...
name: ${name}
version: 1.0.0
description: ${description || 'Luca imprint recording'}
language: javascript
runtime: node
author: user
created: ${new Date().toISOString()}
...
This skill was created via Luca Imprinting (**${mode}** mode).
...
export async function main(args) {
    ...
    return {
        success: true,
        message: "Luca imprint context acknowledged",
        imprint: "${slug}",
        mode: "${mode}",
        args
    };
