...
# Shared model metadata for routers/models.py (extracted model endpoints).
state.PLATFORM_INFO = PLATFORM_INFO
state.is_model_supported = is_model_supported
...
# Share with routers/models.py (canary probe).
state.embedding_logic = embedding_logic
...
from routers.deps import lazy_import_automation
