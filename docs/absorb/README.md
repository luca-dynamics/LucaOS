...
| **3 Ecosystem + skills** | **Partial → marketplace pilot** | MCP/plugins, skill lifecycle, dry-run; **SkillMarketplaceService** import/export/lifecycle/dry-run; **Skill Marketplace** settings UI (OpenClaw/Claude tools/MCP); LucaLink skill sync + live sandbox execution open |
