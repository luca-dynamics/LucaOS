...
| --- | --- | --- |
| **1 Stability + execution** | **Partial → real wire + UI** | Gates + tape; product complete API; workforce + CU; **UnifiedMissionCenterPanel** (settings full + right-panel compact): start/goals/complete; PI Mission Profile stays **read-only advisory** |
