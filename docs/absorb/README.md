...
| --- | --- | --- |
| **1 Stability + execution** | **Partial → real wire + UI** | Gates + tape; product complete API; workforce/CU MissionControl loop; **Mission Center** live poll, readiness, blocked-gate detail, tape timeline, **checkpoint/rollback (tape-level pilot)**; PI Mission Profile stays **read-only advisory** |
