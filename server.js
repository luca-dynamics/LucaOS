...
import { mcpClientManager } from './cortex/server/services/mcpClientManager.js';
import './cortex/server/services/wechatService.js';
...
import tasksRoutes from './cortex/server/api/routes/tasks.routes.js';
import automationRoutes from './cortex/server/api/routes/automation.routes.js';
import autonomyRoutes from './cortex/server/api/routes/autonomy.routes.js';
...
import nodeRoutes from './cortex/server/api/routes/node.routes.js';
...
import lucaLinkRoutes from './cortex/server/api/routes/lucaLink.routes.js';
...
import twitterRoutes from './cortex/server/api/routes/twitter.routes.js';
import instagramRoutes from './cortex/server/api/routes/instagram.routes.js';
import linkedinRoutes from './cortex/server/api/routes/linkedin.routes.js';
import discordRoutes from './cortex/server/api/routes/discord.routes.js';
import youtubeRoutes from './cortex/server/api/routes/youtube.routes.js';
import socialSkillsRoutes from './cortex/server/api/routes/social-skills.routes.js';
import wechatRoutes from './cortex/server/api/routes/wechat.routes.js';
import personaRoutes from './src/cortex/server/api/routes/persona.routes.js';
...
// MCP Auto-Connect (reads from ~/.luca/data/mcp-settings.json)
...
try {
    ...
    console.log('[GOAL_SCHEDULER] Standing by for God Mode toggle...');
    // goalScheduler.initialize(); // DISABLED: Waits for God Mode Toggle
...
// It will be started when user clicks "Link Device" via /api/luca-link/start
...
app.use('/api/tasks', tasksRoutes); // NEW: Task/Goal management
...
app.use('/api/luca-link', lucaLinkRoutes);
...
app.use('/api/social-skills', socialSkillsRoutes);
